...
public class VerticalRecyclableScrollerDemo : MonoBehaviour, IRecyclableScrollRectDataSource
{
    [SerializeField]
    ...
    private void InitData()
    {
        ...
        for (int i = 0; i < _dataLength; i++)
        {
            ...
            obj.id = "item : " + i;
            obj.height = Random.Range(50f, 300f);
            obj.width = 380f;
    ...
    public float GetWidth(int index)
    {
        ...
        return _contactList[index].width;
    }
